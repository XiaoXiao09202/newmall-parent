package com.xiao.newmall.realtime.bean
...
case class OrderDetailWide(
                      ...
                      var user_id: Long=0L,
                      var sku_id: Long=0L,
                      var sku_price:Double=0D,//单价
                      var sku_num:Long=0L,    //数量
                      var sku_name:String=null,
                      var benefit_reduce_amount:Double=0D,
                      var original_total_amount:Double=0D,//原始总额
                      var feight_fee:Double=0D,
                      var final_total_amount:Double=0D,//实付总额
                      var final_detail_amount:Double=0D,//求：实付分摊
